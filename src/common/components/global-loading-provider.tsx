...
function GlobalLoadingProvider() {
  ...
  return (
    <div className="fixed left-0 top-0 z-10 flex h-screen w-screen items-center justify-center bg-black/20">
      <div role="status">
        <svg
          aria-hidden="true"
          className="h-16 w-16 animate-spin fill-primary text-gray-light"
          viewBox="0 0 100 101"
          fill="none"
